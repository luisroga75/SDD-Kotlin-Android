...
| Contexto del agente | AGENTS.md en Codex; AGENTS.md importado desde CLAUDE.md en la variante Claude nueva. |
...
Codex: [AGENTS.md](https://developers.openai.com/codex/guides/agents-md/) y [skills](https://learn.chatgpt.com/docs/build-skills). Claude Code: [skills](https://code.claude.com/docs/en/skills) e [imports de CLAUDE.md](https://code.claude.com/docs/en/memory). Cada variante se instala de forma independiente: `~/.agents/skills` para Codex (o el directorio compatible ya utilizado, como `~/.codex/skills`) y `~/.claude/skills` para Claude Code. Conserva una sola copia descubierta por agente. No necesitas instalar ambos.
