...
Adapta los campos entre llaves al caso real o conviértelos en una pregunta concreta. Son procedimientos comunes a las dos variantes. Invoca `$android-kotlin-sdd` en Codex o `/android-kotlin-sdd` en Claude Code; no presupongas herramientas del otro agente.

## P0. Arrancar o entender un proyecto

```text
Usa la skill android-kotlin-sdd para ayudarme a definir {idea de app Android}.
...
```text
Crea o mejora las instrucciones de la raíz de {proyecto} para mi agente.
En Codex lee los AGENTS.md/AGENTS.override.md aplicables; en Claude Code,
CLAUDE.md y sus imports. Lee también la constitución.
...
Remite a documentos, sin duplicarlos. Para Codex solo, usa AGENTS.md.
Para Claude nuevo o equipo mixto, propone AGENTS.md común y CLAUDE.md con
@AGENTS.md, como en el curso. No asumas que Claude lee AGENTS sin importarlo.
Si ya existe solo CLAUDE.md, conserva sus instrucciones y esa estructura.
